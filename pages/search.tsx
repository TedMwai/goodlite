      ...
      <div>
        <main className={montserrat.className}>
          ...
          <div className="px-5 py-12 mx-auto md:px-12 lg:px-16">
            {products.length === 0 ? (
              <div>
                <h1 className="text-3xl md:text-3xl lg:text-4xl xl:text-4xl font-medium text-center">
                  No products found for the search query &quot;{query}&quot;
                </h1>
              </div>
            ) : (
              <div>
            ...
            <div className="mt-8 grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-x-6 gap-y-20 xl:gap-x-4 xl:gap-y-12">
              {products.length > 0 &&
